...
export const runtimeConfig: RuntimeConfig = {
  ...
  vars: ["MISSIONRY_IDLE_MS", "MISSIONRY_R2_PREFIX", "E2B_TEMPLATE_ID", "MISSIONRY_E2B_CENTS_PER_MIN", "DEMO_E2B_MODE", "EDGESPARK_ENV", "NODE_ENV", "EDGESPARK_DEV_AS_ADMIN", "MISSIONRY_FORCE_MOCK_AI", "MISSIONRY_SUPER_ADMIN_USER_IDS", "MISSIONRY_DEV_HEADER_SECRET"],
};
